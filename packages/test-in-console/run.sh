...
./meteor npm init -y --prefix ${tmp_npm_path}
./meteor npm install selenium-webdriver@3.0.0-beta-3 --save --prefix ${tmp_npm_path}
...
./meteor node "$METEOR_HOME/packages/test-in-console/runner.js" 2>&1
STATUS=$?

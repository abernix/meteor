...
var addReproHelpers = function (tmpl) {
  tmpl.helpers({
    array: function () {
      return [1,2,3,4]
    },
...
Tinytest.add(
  "spacebars - exampleOk1", function (test, expect) {
    var tmpl = Template.exampleOk1;

    addReproHelpers(tmpl);

    // No template chosen
    var div = renderToDiv(tmpl);
    test.equal(canonicalizeHtml(div.innerHTML), "<table><tbody><tr><td>tdokayguts1</td></tr><!----></tbody></table>");
});

Tinytest.add(
  "spacebars - exampleOk2", function (test, expect) {
    var tmpl = Template.exampleOk2;

    addReproHelpers(tmpl);

    // No template chosen
    var div = renderToDiv(tmpl);
    test.equal(canonicalizeHtml(div.innerHTML), "<table><tbody><!----><tr><td>tdokayguts2</td></tr></tbody></table>");
});

Tinytest.add(
  "spacebars - exampleOk3", function (test, expect) {
    var tmpl = Template.exampleOk3;

    addReproHelpers(tmpl);

    // No template chosen
    var div = renderToDiv(tmpl);
    test.equal(canonicalizeHtml(div.innerHTML), "<table><tbody><tr><td>tdokayguts3</td></tr></tbody></table>");
});

Tinytest.add(
  "spacebars - exampleBug1", function (test, expect) {
    var tmpl = Template.exampleBug1;

    addReproHelpers(tmpl);

    // No template chosen
    var div = renderToDiv(tmpl);
    test.equal(canonicalizeHtml(div.innerHTML), "<table><tbody><!----><tr><td>tdguts1</td></tr></tbody></table>");
});

Tinytest.add(
  "spacebars - exampleBug2", function (test, expect) {
    var tmpl = Template.exampleBug2;

    addReproHelpers(tmpl);

    // No template chosen
    var div = renderToDiv(tmpl);
    test.equal(canonicalizeHtml(div.innerHTML), "<table><tbody><!----><tr><td>tdguts2</td></tr></tbody></table>");
});

Tinytest.add(
  "spacebars - exampleBug3", function (test, expect) {
    var tmpl = Template.exampleBug3;

    addReproHelpers(tmpl);

    // No template chosen
    var div = renderToDiv(tmpl);
    test.equal(canonicalizeHtml(div.innerHTML), "<table><tbody><!----><tr><td>tdguts3</td></tr></tbody></table>");
});

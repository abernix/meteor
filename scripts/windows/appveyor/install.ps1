Write-Output "Appveyor architecture: $env:PLATFORM"
...
Write-Output "Repo build branch is: $env:APPVEYOR_REPO_BRANCH"
Write-Output "Build folder is: $env:APPVEYOR_BUILD_FOLDER"
